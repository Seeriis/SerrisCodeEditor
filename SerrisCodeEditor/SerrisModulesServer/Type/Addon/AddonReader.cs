...
namespace SerrisModulesServer.Type.Addon
{
    public class AddonReader
    {
        ...
        {
            StorageFolder folder_module;
            StackPanel widget_content = new StackPanel { Padding = new Thickness(5, 0, 5, 0), Orientation = Orientation.Horizontal, Name = "" + id_module };
                        ...
                        foreach(AddonWidget widget in list)
                        {
                            switch(widget.Type)
                            {
                                case WidgetType.Button:
                                    Button new_button = new Button(); new_button.Margin = new Thickness(5, 0, 5, 0);
                                ...
                                case WidgetType.TextBox:
                                    TextBox new_textbox = new TextBox(); new_textbox.Margin = new Thickness(5, 0, 5, 0);
