    ...
    tokenizer: {
        ...
        root: [
            ...
            [/^(\s*)([a-z_]\w*[!?=]?)/, ['white',
                {
                    cases: {
                        'for|until|while': { token: 'keyword.$2', bracket: '@open', next: '@dodecl.$2' },
            ...
            [/[a-z_]\w*[!?=]?/,
                {
                    cases: {
                        'if|unless|while|until': { token: 'keyword.$0x', bracket: '@open', next: '@modifier.$0x' },
        ...
        dodecl: [
            ...
            [/[a-z_]\w*[!?=]?/, {
                cases: {
                    'end': { token: 'keyword.$S2', bracket: '@close', next: '@pop' }, // end on same line
        ...
        dstring: [
            ...
            [/[`"]/, {
                cases: {
                    '$#==$S3': { token: 'string.$S2.delim', bracket: '@close', next: '@pop' },
                    '@default': 'string.$S2'
                }
            }]
        ],
        ...
        heredoc: [
            [/^(\s*)(@heredelim)$/, {
                cases: {
                    '$2==$S2': ['string.heredoc', { token: 'string.heredoc.delimiter', bracket: '@close', next: '@pop' }],
        ...
        pregexp: [
            ...
            [/[^\(\{\[\\]/, {
                cases: {
                    '$#==$S3': { token: 'regexp.delim', bracket: '@close', next: '@pop' },
        ...
        qstring: [
            ...
            [/./, {
                cases: {
                    '$#==$S4': { token: 'string.$S2.delim', bracket: '@close', next: '@pop' },
